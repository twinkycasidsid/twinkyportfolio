...
export default function Navbar() {
  return (
    <div className="h-15 fixed top-5 left-0 right-0 z-50 flex justify-center">
      <nav className="flex items-center justify-center space-x-10 px-24 py-4 rounded-full bg-[#6953a6] text-white font-semibold border border-white/20 shadow-[0_3px_5px_rgba(0,0,0,0.15)] hover:shadow-[0_3px_20px_rgba(0,0,0,0.35)] transition-all duration-300 backdrop-blur-xl">
